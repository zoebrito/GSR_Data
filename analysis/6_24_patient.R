...
data <- read_excel("data/6_24_GSR_COPY.xlsx")
...
positive_control_start <- 26.8
positive_control_end <- 28.8
positive_control_baseline_start <- 24.8
positive_control_baseline_end <- 26.8

pain_attack_start <- 980
pain_attack_end <- 1030
pain_attack_baseline_start <- 960
pain_attack_baseline_end <- 980

# Calculate AUC for positive control and pain attack
